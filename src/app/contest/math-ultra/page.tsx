    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-slate-50 py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-slate-900 mb-2">Супер күрделі математика</h1>
          <p className="text-slate-600">Көпқадамды есептер, аралас амалдар, стратегиялық есептер</p>
        </div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center justify-center gap-4">
              ...
              <button
                ...
                className="px-6 py-3 bg-gradient-to-r from-blue-500 to-cyan-500 text-white rounded-xl font-medium disabled:opacity-40 disabled:cursor-not-allowed hover:opacity-90 transition-all"
              >
                Келесі →
              </button>
            </div>
