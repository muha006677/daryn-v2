...
export default function KazEssayPage() {
    ...
    <div className="min-h-screen bg-gradient-to-b from-amber-50 to-slate-50 py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-slate-900 mb-2">Эссе</h1>
          <p className="text-slate-600">Тақырып бойынша қысқа эссе жазу</p>
        </div>
