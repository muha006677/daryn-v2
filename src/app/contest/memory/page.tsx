    ...
    <div className="min-h-screen bg-gradient-to-b from-violet-50 to-slate-50 py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-slate-900 mb-2">Есте сақтау PRO</h1>
          <p className="text-slate-600">Назар тұрақтылығы + жылдам қайта жаңғырту</p>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-center gap-3 bg-white rounded-xl p-4 shadow-sm">
              ...
              <button
                onClick={loadQuestions}
                className="px-4 py-2 bg-violet-500 text-white rounded-xl font-medium hover:bg-violet-600 transition-all"
              >
                Жаңарту
              </button>
            </div>
