    ...
    <div className="min-h-screen bg-gradient-to-b from-teal-50 to-slate-50 py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-slate-900 mb-2">Дүниетану quick Q&A</h1>
          <p className="text-slate-600">Жеңіл өмір/табиғат/қоғам сұрақтары</p>
        </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-slate-200 p-8">
            <div className="flex items-center justify-center gap-3 mb-6">
              ...
              <select
                ...
                className="px-4 py-2 rounded-xl border border-slate-300 focus:ring-2 focus:ring-teal-500 outline-none"
              >
                {['1', '2', '3', '4', '5', '6'].map(g => (
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center justify-center gap-4">
              ...
              <button
                ...
                className="px-6 py-3 bg-gradient-to-r from-teal-500 to-cyan-500 text-white rounded-xl font-medium disabled:opacity-40 disabled:cursor-not-allowed hover:opacity-90 transition-all"
              >
                Келесі →
              </button>
              <button
